...
import io.github.crabzilla.command.ViewEffect.GivenEachEventViewEffect
...
class CustomerGivenEachEventViewEffect :
  GivenEachEventViewEffect<Customer, CustomerEvent> {
  override fun handle(
