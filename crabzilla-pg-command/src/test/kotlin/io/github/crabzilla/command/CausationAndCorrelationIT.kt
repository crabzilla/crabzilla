...
class CausationAndCorrelationIT : AbstractCommandHandlerIT() {
  @Test
  fun `when handling handle 4 commands, causation and correlation are correct`(
    ...
    commandHandler.handle(targetStream, cmd1)
      ...
      .compose { commandHandler.handle(targetStream, cmd3) }
      .compose { commandHandler.handle(targetStream, cmd4) }
//    handler
