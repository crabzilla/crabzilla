...
@DisplayName("A VertxSnapshotMessageFn")
public class VertxSnapshotMessageFnTest {
  ...
  public void on_empty_history_then_returns_version_0() throws ExecutionException {
    ...
    val reader = new VertxSnapshotMessageFn<Customer>(cache, eventRepository, snapshotFactory);
