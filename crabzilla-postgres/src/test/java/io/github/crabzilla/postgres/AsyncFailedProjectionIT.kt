...
import io.github.crabzilla.postgres.command.CommandsContext
import io.github.crabzilla.postgres.command.SnapshotType
  ...
  fun a0(tc: VertxTestContext, vertx: Vertx) {
    ...
    snapshotRepo.get(id)
      ...
      .onSuccess { snapshot0 ->
        ...
        val onSuccess = controller.handle(CommandMetadata(Metadata.StateId(id)), RegisterCustomer(id, "cust#$id"))
          .onFailure { tc.failNow(it) }
          .onSuccess {
            snapshotRepo.get(id)
