...
class PgcClientProjectionIT {
  ...
  companion object {
    private val log = LoggerFactory.getLogger(PgcClientProjectionIT::class.java)
  }
  ...
  fun a0(tc: VertxTestContext, vertx: Vertx) {
    ...
    val controller = client.create(customerConfig, true, CustomerEventsProjector)
    snapshotRepo.get(id)
