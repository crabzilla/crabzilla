...
// import io.github.crabzilla.core.TypedEventPublisher
...
// */
// class PgcEventsTypedPublisher<E : DomainEvent>(
//  private val jsonEventPublisher: TypedEventPublisher<E>,
...
//
//  companion object {
//    private val log = LoggerFactory.getLogger(PgcEventsTypedPublisher::class.java)
...
//            val futures: List<Future<Void>> = listOfTriple.map { it -> jsonEventPublisher.publish(it.third, it.first, it.second) }
