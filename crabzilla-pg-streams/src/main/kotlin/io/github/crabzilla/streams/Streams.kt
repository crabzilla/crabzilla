...
import io.github.crabzilla.streams.StreamWriter.Companion.SQL_GET_STREAM
...
// TODO WIP consider moving streams to a new module and public api, wrapped as a verticle to be manageable
...
class StreamRepository<S : Any, E : Any>(
...
class StreamWriter<S : Any, E : Any>(
  private val conn: SqlConnection,
  private val targetStream: TargetStream,
