...
. Retrieve the target https://github.com/crabzilla/crabzilla/blob/main/crabzilla-pgclient/src/main/kotlin/io/github/crabzilla/command/internal/Snapshot.kt[Snapshot].
