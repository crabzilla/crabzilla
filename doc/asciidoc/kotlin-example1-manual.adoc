...
* https://github.com/crabzilla/crabzilla/blob/master/crabzilla-vertx-projector/src/main/java/io/github/crabzilla/vertx/projection/ProjectionHandlerService.java[ProjectionHandlerService] to propagate and project events to read model database
