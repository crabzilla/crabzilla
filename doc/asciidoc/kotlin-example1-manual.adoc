...
----
include::./crabzilla-example1/crabzilla-example1-database/src/main/java/io/github/crabzilla/example1/CustomerSummaryDao.kt[tags=dao]
----
...
.CustomerFactory
----
include::./crabzilla-example1/crabzilla-example1-service/src/main/java/io/github/crabzilla/example1/customer/CustomerFactory.kt[tags=factory]
----
...
----
include::./crabzilla-example1/crabzilla-example1-service/src/main/java/io/github/crabzilla/example1/Example1EventProjector.kt[tags=projector]
----

==== 3.2.2 Example1Module

https://github.com/crabzilla/crabzilla/blob/master/crabzilla-example1/crabzilla-example1-service/src/main/java/io/github/crabzilla/example1/Example1Module.kt[Example1Module]
