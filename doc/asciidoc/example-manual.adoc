...
.Customer.java
----
include::./crabzilla-example1/crabzilla-example1-core/src/main/java/io/github/crabzilla/example1/customer/Customer.java[ ]
----
...
----
include::./crabzilla-example1/crabzilla-example1-core/src/main/java/io/github/crabzilla/example1/services/SampleInternalService.java[ ]
----
...
----
include::./crabzilla-example1/crabzilla-example1-core/src/main/java/io/github/crabzilla/example1/readmodel/CustomerSummary.java[ ]
----
...
----
include::./crabzilla-example1/crabzilla-example1-core/src/main/java/io/github/crabzilla/example1/readmodel/CustomerRepository.java[ ]
----
...
----
include::./crabzilla-example1/crabzilla-example1-database/src/main/java/io/github/crabzilla/example1/CustomerSummaryDao.java[ ]
----
...
.CustomerFactory
----
include::./crabzilla-example1/crabzilla-example1-service/src/main/java/io/github/crabzilla/example1/customer/CustomerFactory.java[ ]
----
...
.CustomerModule
----
include::./crabzilla-example1/crabzilla-example1-service/src/main/java/io/github/crabzilla/example1/customer/CustomerModule.java[ ]
----
...
----
include::./crabzilla-example1/crabzilla-example1-service/src/main/java/io/github/crabzilla/example1/Example1EventProjector.java[ ]
----
