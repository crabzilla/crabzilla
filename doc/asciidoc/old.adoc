...
//handler verticles will wrap the result of this function into a result type something like https://github.com/crabzilla/crabzilla/blob/master/crabzilla-core/src/main/java/io/github/crabzilla/core/CommandResult.kt[CommandSideEffect]
//[source,kotlin]
//.CustomerFunctions.kt
//----
