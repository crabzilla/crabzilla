...
.Customer.kt
----
include::./crabzilla-kotlin-example1/crabzilla-kotlin-example1-core/src/main/java/io/github/crabzilla/example1/customer/Customer.kt[ ]
----
...
.services.kt
----
include::./crabzilla-kotlin-example1/crabzilla-kotlin-example1-core/src/main/java/io/github/crabzilla/example1/services.kt[ ]
----
...
.readmodel.kt
----
include::./crabzilla-kotlin-example1/crabzilla-kotlin-example1-core/src/main/java/io/github/crabzilla/example1/readmodel.kt[ ]
----
...
----
include::./crabzilla-kotlin-example1/crabzilla-kotlin-example1-database/src/main/java/io/github/crabzilla/example1/CustomerSummaryDao.kt[ ]
----
...
.CustomerFactory
----
include::./crabzilla-kotlin-example1/crabzilla-kotlin-example1-service/src/main/java/io/github/crabzilla/example1/customer/CustomerFactory.kt[ ]
----
...
.CustomerModule
----
include::./crabzilla-kotlin-example1/crabzilla-kotlin-example1-service/src/main/java/io/github/crabzilla/example1/customer/CustomerModule.kt[ ]
----
...
----
include::./crabzilla-kotlin-example1/crabzilla-kotlin-example1-service/src/main/java/io/github/crabzilla/example1/Example1EventProjector.kt[ ]
----
...
* https://github.com/crabzilla/crabzilla/blob/master/crabzilla-vertx/src/main/java/io/github/crabzilla/vertx/verticles/CommandRestVerticle.kt[CommandRestVerticle] to receive commands as JSON
* https://github.com/crabzilla/crabzilla/blob/master/crabzilla-vertx/src/main/java/io/github/crabzilla/vertx/verticles/CommandHandlerVerticle.kt[CommandHandlerVerticle] to validate and process commands against the aggregate
* https://github.com/crabzilla/crabzilla/blob/master/crabzilla-vertx/src/main/java/io/github/crabzilla/vertx/repositories/EntityUnitOfWorkRepository.kt[EntityUnitOfWorkRepository] to store resulting unit of work /events into a single table
* https://github.com/crabzilla/crabzilla/blob/master/crabzilla-vertx/src/main/java/io/github/crabzilla/vertx/verticles/EventsProjectionVerticle.kt[EventsProjectionVerticle] to propagate and project events to read model database
