...
* https://github.com/crabzilla/crabzilla/blob/main/crabzilla-command/src/main/kotlin/io/github/crabzilla/command/CommandController.kt[CommandController] is consistent by default: before handling a command, your state ID is pessimistically locked using https://www.postgresql.org/docs/14/explicit-locking.html#ADVISORY-LOCKS[Postgres Advisory Locks]
* https://github.com/crabzilla/crabzilla/blob/main/crabzilla-projection/src/main/kotlin/io/github/crabzilla/projection/EventsProjectorVerticle.kt[EventsProjectorVerticle] allows handling your read model projection's strait from database: no need to publish your events to Kafka or NATS.
...
* JSON serialization using https://kotlinlang.org/docs/serialization.html[Kotlin serialization] or https://github.com/FasterXML/jackson-module-kotlin[Jackson Kotlin Module]
