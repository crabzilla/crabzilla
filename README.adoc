...
** a sink:
*** to an implementation of https://github.com/crabzilla/crabzilla/blob/main/crabzilla-stack/src/main/kotlin/io/github/crabzilla/EventProjector.kt[EventProjector] implementation in order to update your view model in Postgres.
