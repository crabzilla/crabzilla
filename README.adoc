...
** a sink:
*** to your view models in Postgres by implementing https://github.com/crabzilla/crabzilla/blob/main/crabzilla-stack/src/main/kotlin/io/github/crabzilla/EventProjector.kt[EventProjector].
