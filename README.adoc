...
https://vertx.io[image:https://img.shields.io/badge/vert.x-4.2.4-purple.svg[Vertx]]
...
* https://github.com/crabzilla/crabzilla/blob/main/crabzilla-pgclient/src/main/java/io/github/crabzilla/pgclient/command/CommandController.kt[CommandController] is consistent by default: before handling a command, your state ID is pessimistically locked using https://www.postgresql.org/docs/14/explicit-locking.html#ADVISORY-LOCKS[Postgres Advisory Locks]
* https://github.com/crabzilla/crabzilla/blob/main/crabzilla-pgclient/src/main/java/io/github/crabzilla/pgclient/projection/EventsProjectorVerticle.kt[EventsProjectorVerticle] allows handling your read model projection's strait from database: no need to publish your events to Kafka or NATS.
