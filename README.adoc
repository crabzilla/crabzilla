...
== Update: 2025
I decided to start another experiment: https://github.com/rodolfodpk/crablet. Crabzilla is problably going to be freezed. It's a opinionated framework. 
But all I wanted was a good Event Source library. Anyway, I have learned learned a lote when developing it. 
