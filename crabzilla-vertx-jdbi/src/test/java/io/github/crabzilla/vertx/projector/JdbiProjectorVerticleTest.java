...
public class JdbiProjectorVerticleTest {
  ...
  public void setUp(TestContext context) {
    ...
    JdbiProjectorVerticle<CustomerSummaryProjectionDao> verticle =
            new JdbiProjectorVerticle<>(EVENTS_ENDPOINT, eventsProjector, circuitBreaker);
