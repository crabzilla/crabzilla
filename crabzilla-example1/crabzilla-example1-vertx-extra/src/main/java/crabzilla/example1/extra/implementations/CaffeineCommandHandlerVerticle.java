...
@Slf4j
public class CaffeineCommandHandlerVerticle<A extends AggregateRoot> extends AbstractVerticle {
  ...
  @Inject
  public CaffeineCommandHandlerVerticle(@NonNull final Class<A> aggregateRootClass,
