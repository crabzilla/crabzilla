...
import io.github.crabzilla.vertx.entity.EntityUnitOfWorkJournal
...
class CustomerModule {
  ...
  fun handlerVerticle(service: SampleInternalService,
                      eventJournal: EntityUnitOfWorkJournal,
  ...
  @Provides
  @Singleton
  fun uowRepo(@WriteDatabase jdbcClient: JDBCClient): EntityUnitOfWorkJournal {
    return EntityUnitOfWorkJournal(Customer::class.java, jdbcClient)
  }
