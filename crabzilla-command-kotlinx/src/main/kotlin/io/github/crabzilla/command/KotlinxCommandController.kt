...
class KotlinxCommandController<S : Any, C : Any, E : Any>(
  vertx: Vertx,
  pgPool: PgPool,
  ...
  companion object {
    private val log = LoggerFactory.getLogger(KotlinxCommandController::class.java)
    ...
    ): KotlinxCommandController<S, C, E> {
      val instance = KotlinxCommandController(vertx, pgPool, json, commandComponent, options)
